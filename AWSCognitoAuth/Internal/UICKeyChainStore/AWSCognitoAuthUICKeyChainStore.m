...
NSString * const AWSCognitoAuthUICKeyChainStoreErrorDomain = @"com.kishikawakatsumi.uickeychainstore";
static NSString *_defaultService;

@interface AWSCognitoAuthUICKeyChainStore ()

@end

@implementation AWSCognitoAuthUICKeyChainStore
...
+ (AWSCognitoAuthUICKeyChainStore *)keyChainStoreWithService:(NSString *)service
{
    return [[self alloc] initWithService:service accessGroup:nil];
}

+ (AWSCognitoAuthUICKeyChainStore *)keyChainStoreWithService:(NSString *)service accessGroup:(NSString *)accessGroup
{
...
- (instancetype)initWithService:(NSString *)service accessGroup:(NSString *)accessGroup
{
    self = [super init];
    if (self) {
        _itemClass = AWSCognitoAuthUICKeyChainStoreItemClassGenericPassword;
...
- (instancetype)initWithServer:(NSURL *)server protocolType:(AWSCognitoAuthUICKeyChainStoreProtocolType)protocolType authenticationType:(AWSCognitoAuthUICKeyChainStoreAuthenticationType)authenticationType
{
    self = [super init];
    if (self) {
        _itemClass = AWSCognitoAuthUICKeyChainStoreItemClassInternetPassword;
...
+ (NSString *)stringForKey:(NSString *)key service:(NSString *)service accessGroup:(NSString *)accessGroup error:(NSError *__autoreleasing *)error
{
    ...
    AWSCognitoAuthUICKeyChainStore *keychain = [AWSCognitoAuthUICKeyChainStore keyChainStoreWithService:service accessGroup:accessGroup];
...
+ (NSArray UIC_KEY_TYPE *)allKeysWithItemClass:(AWSCognitoAuthUICKeyChainStoreItemClass)itemClass
{
    CFTypeRef itemClassObject = kSecClassGenericPassword;
    if (itemClass == AWSCognitoAuthUICKeyChainStoreItemClassGenericPassword) {
        itemClassObject = kSecClassGenericPassword;
    } else if (itemClass == AWSCognitoAuthUICKeyChainStoreItemClassInternetPassword) {
...
+ (NSArray *)allItemsWithItemClass:(AWSCognitoAuthUICKeyChainStoreItemClass)itemClass
{
    CFTypeRef itemClassObject = kSecClassGenericPassword;
    if (itemClass == AWSCognitoAuthUICKeyChainStoreItemClassGenericPassword) {
        itemClassObject = kSecClassGenericPassword;
...
- (NSMutableDictionary *)attributesWithKey:(NSString *)key value:(NSData *)value error:(NSError *__autoreleasing *)error
{
    ...
    if (_authenticationPolicy && accessibilityObject) {
        ...
        if (floor(NSFoundationVersionNumber) <= floor(iOS_7_1_or_10_9_2) && _accessibility == AWSCognitoAuthUICKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly) {
#if TARGET_OS_IOS
...
{
    switch (_itemClass) {
        case AWSCognitoAuthUICKeyChainStoreItemClassGenericPassword:
            return kSecClassGenericPassword;
        case AWSCognitoAuthUICKeyChainStoreItemClassInternetPassword:
...
- (CFTypeRef)protocolTypeObject
{
    switch (_protocolType) {
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeFTP:
            return kSecAttrProtocolFTP;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeFTPAccount:
            return kSecAttrProtocolFTPAccount;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeHTTP:
            return kSecAttrProtocolHTTP;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeIRC:
            return kSecAttrProtocolIRC;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeNNTP:
            return kSecAttrProtocolNNTP;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypePOP3:
            return kSecAttrProtocolPOP3;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeSMTP:
            return kSecAttrProtocolSMTP;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeSOCKS:
            return kSecAttrProtocolSOCKS;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeIMAP:
            return kSecAttrProtocolIMAP;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeLDAP:
            return kSecAttrProtocolLDAP;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeAppleTalk:
            return kSecAttrProtocolAppleTalk;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeAFP:
            return kSecAttrProtocolAFP;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeTelnet:
            return kSecAttrProtocolTelnet;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeSSH:
            return kSecAttrProtocolSSH;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeFTPS:
            return kSecAttrProtocolFTPS;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeHTTPS:
            return kSecAttrProtocolHTTPS;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeHTTPProxy:
            return kSecAttrProtocolHTTPProxy;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeHTTPSProxy:
            return kSecAttrProtocolHTTPSProxy;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeFTPProxy:
            return kSecAttrProtocolFTPProxy;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeSMB:
            return kSecAttrProtocolSMB;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeRTSP:
            return kSecAttrProtocolRTSP;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeRTSPProxy:
            return kSecAttrProtocolRTSPProxy;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeDAAP:
        ...
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeLDAPS:
            return kSecAttrProtocolLDAPS;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeTelnetS:
            return kSecAttrProtocolTelnetS;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypeIRCS:
            return kSecAttrProtocolIRCS;
        case AWSCognitoAuthUICKeyChainStoreProtocolTypePOP3S:
...
- (CFTypeRef)authenticationTypeObject
{
    switch (_authenticationType) {
        case AWSCognitoAuthUICKeyChainStoreAuthenticationTypeNTLM:
        ...
        case AWSCognitoAuthUICKeyChainStoreAuthenticationTypeDPA:
            return kSecAttrAuthenticationTypeDPA;
        case AWSCognitoAuthUICKeyChainStoreAuthenticationTypeRPA:
            return kSecAttrAuthenticationTypeRPA;
        case AWSCognitoAuthUICKeyChainStoreAuthenticationTypeHTTPBasic:
            return kSecAttrAuthenticationTypeHTTPBasic;
        case AWSCognitoAuthUICKeyChainStoreAuthenticationTypeHTTPDigest:
            return kSecAttrAuthenticationTypeHTTPDigest;
        case AWSCognitoAuthUICKeyChainStoreAuthenticationTypeHTMLForm:
            return kSecAttrAuthenticationTypeHTMLForm;
        case AWSCognitoAuthUICKeyChainStoreAuthenticationTypeDefault:
...
- (CFTypeRef)accessibilityObject
{
    switch (_accessibility) {
        case AWSCognitoAuthUICKeyChainStoreAccessibilityWhenUnlocked:
            return kSecAttrAccessibleWhenUnlocked;
        case AWSCognitoAuthUICKeyChainStoreAccessibilityAfterFirstUnlock:
            return kSecAttrAccessibleAfterFirstUnlock;
        case AWSCognitoAuthUICKeyChainStoreAccessibilityAlways:
            return kSecAttrAccessibleAlways;
        case AWSCognitoAuthUICKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly:
            return kSecAttrAccessibleWhenPasscodeSetThisDeviceOnly;
        case AWSCognitoAuthUICKeyChainStoreAccessibilityWhenUnlockedThisDeviceOnly:
            return kSecAttrAccessibleWhenUnlockedThisDeviceOnly;
        case AWSCognitoAuthUICKeyChainStoreAccessibilityAfterFirstUnlockThisDeviceOnly:
            return kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly;
        case AWSCognitoAuthUICKeyChainStoreAccessibilityAlwaysThisDeviceOnly:
...
{
    NSError *error = [NSError errorWithDomain:AWSCognitoAuthUICKeyChainStoreErrorDomain code:AWSCognitoAuthUICKeyChainStoreErrorInvalidArguments userInfo:@{NSLocalizedDescriptionKey: message}];
...
{
    NSError *error = [NSError errorWithDomain:AWSCognitoAuthUICKeyChainStoreErrorDomain code:-67594 userInfo:@{NSLocalizedDescriptionKey: message}];
    NSLog(@"error: [%@] %@", @(error.code), error.localizedDescription);
    return error;
}
...
#endif
    NSError *error = [NSError errorWithDomain:AWSCognitoAuthUICKeyChainStoreErrorDomain code:status userInfo:@{NSLocalizedDescriptionKey: message}];
...
{
    NSError *error = [NSError errorWithDomain:AWSCognitoAuthUICKeyChainStoreErrorDomain code:-99999 userInfo:@{NSLocalizedDescriptionKey: message}];
    NSLog(@"error: [%@] %@", @(error.code), error.localizedDescription);
    return error;
}
